    ...
    <form action="{{ route('pokemon.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-6 mt-3">
                ...
                <select class="form-select" id="primary_type" name="primary_type" value="{{ old('primary_type') }}">
            ...
            <div class="col-6 mt-3">
                ...
                <input type="number" class="form-control" name="defense" id="defense" value="{{ old('defense') }}">
            </div>
            <div class="col-6 mt-3">
                <label for="is_legendary" class="form-label">Legendary Status</label>
                <select class="form-select" id="is_legendary" name="is_legendary" value="{{ old('is_legendary') }}">
